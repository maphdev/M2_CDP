...
| __T3_Be5d3__ | Définition des formulaire des modals de la page _"sprints.ejs"_ (modification/suppression) pour l'implémentation des pages _"ejs"_ côté client et des routes côté server. | #12, #14 |  | DONE | 0.5 | Manon P. |
...
| __T3_GEN__ | Implémenter la différenciation entre visiteur et développeurs. Les développeurs ont accès à toutes les fonctionnalités de l'application. Les visiteurs ne peuvent pas créer un nouveu projet, créer/modifier/supprimer des issues/tâches, ou modifier les paramètres d'un projet. | #15 |  | DONE | 0.5 | Manon P. |
